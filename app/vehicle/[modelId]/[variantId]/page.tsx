              ...
              <div className="border-b border-border">
                      <div className="max-w-7xl mx-auto px-6 py-4">
                                <nav className="flex items-center gap-2 text-sm text-text-muted flex-wrap">
                                            ...
                                            <ChevronRight size={14} />
                                            <span className="text-text-primary font-medium">{variant.name}</span>span>
                                </nav>nav>
                      </div>div>
              </div>div>
              ...
              <section className="border-b border-border">
                      <div className="max-w-7xl mx-auto px-6 py-10">
                                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                                            <div>
                                                          <p className="section-label mb-2">{model.name} · {variant.year}</p>p>
              ...
              <section className="max-w-7xl mx-auto px-6 py-10">
                ...
                {filteredImages.length > 0 ? (
                    ...
                    <div className="text-center py-24">
                                <p className="text-text-muted text-lg mb-2">Sin imágenes</p>p>
                  ...
                  <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 animate-scale-in">
                            <div className="flex items-center gap-3 bg-zinc-900 border border-border rounded-2xl shadow-2xl px-5 py-3">
                                        <span className="text-sm text-text-secondary whitespace-nowrap">
                                                      <span className="font-semibold text-text-primary">{selectedIds.size}</span>span>{' '}
